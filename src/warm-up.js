...
// var ...
var series = "Harry Potter";
var title = `${series} and the Deathly Hollows`;
var pages = 607;
...
var pageCount = Math.round(pageCount / 4);
...
var sequel = `${series} and the Last of the Deatheaters`;
...
var books = ["The Right Stuff", "The Plot Against America", "The Passionate Programmer", "The Subtle Art of not Giving a Fuck", "Hillbilly Elegy"];
...
var belowTwoHundred = [23, 9, 26, 68, 99, 66, 19, 5, 48, 55, 41, 8];
